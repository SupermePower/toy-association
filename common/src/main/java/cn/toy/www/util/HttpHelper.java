...
public class HttpHelper {
    ...
    protected static int MAX_CONNECTION_COUNT = 150;
    /**
     * 1s
      */
     ...
     * 1s
     */
    protected static int SOCKET_TIMEOUT = 3000;
    /**
     * 1s
     */
    protected static int CONNECTION_REQUEST_TIMEOUT = 1000;

    /**
     * ms
     */
    protected static int WAIT_MILLI_SECONDS = 100;
    ...
    public HttpResult postDLBPayOrder(String url, JSONObject params, String accessKey, String timeStamp, String token) throws Exception {
    ...
    public HttpResult getDLBPayQuery(String url, Map<String, String> params,String accessKey, String timeStamp, String token) throws Exception {
        long begin = 0L;
        try {
            if (params != null) {
                if (params.size() > 0) {
...
/*            LOGGER.debug("url: {}, params: {}, statusCode: {}, responseBody: {}, cost: {}",
    ...
    public static HttpHelper getInstance(String token) {
        if (null == uniqueInstance) {
            synchronized (HttpHelper.class) {
                if (null == uniqueInstance) {
                    uniqueInstance = new HttpHelper(token);
                }
            }
        }
        return uniqueInstance;
...
/*        List<NameValuePair> formParams = map2FormParams(params);
    ...
    public HttpResult postFormBody(String url, String params) throws Exception {
/*        List<NameValuePair> formParams = map2FormParams(params);
        UrlEncodedFormEntity entity = new UrlEncodedFormEntity(formParams, "UTF-8");*/
        ...
        try {
            ...
            LOGGER.debug("url: {}, params: {}, cost: {}",
                    url, params, System.currentTimeMillis() - begin);
        ...
        LOGGER.debug("url: {}, params: {}, statusCode: {}, responseBody: {}, cost: {}",
                url, params, statusCode, content, end - begin);
        return new HttpResult(statusCode, content);
    }
